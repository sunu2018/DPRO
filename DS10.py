...
client = LINE("Ev0Q1rwEzWGcoO3fUFhf.6nK7QU+e+3Ow8fEI/Ld17W.y9RQKSzZek38I2iyOGYh9uew3zt3aCbNeDJGmG4jeEM=")
print ("===============[PRO LEADER LOGIN SUKSES]===============\n")
ki1 = LINE("Euue9CsFaTZmli3VqoPe.o06u8YlkPK5Q3FCvOuFsxG.ifVWkBuSX99vHo57XrbI8yLl9UH3mjMwXhSDxCE5xV8=")
print ("===============[PRO 1 LOGIN SUKSES]===============\n")
ki2 = LINE("EuQe4L7NAnAQEiKaMJI5.OJNXQFcg5j/mbRXc26tgbq.kOnAnw9Mh2FP9RHMnbb9DtJxGEqs7UwzakJpD8898KQ=")
print ("===============[PRO 2 LOGIN SUKSES]===============\n")
ki3 = LINE("EuWfkMMoKqOGL4a6lJKf.eWMynGGci6AiGTQDWAZLJW.H0pAScOORQJ5LmBVRvnmbg1FA4w8TvDtrVI3EjMfUYs=")
print ("===============[PRO 3 LOGIN SUKSES]===============\n")
ki4 = LINE("EuCzeZTgzgpqitRsNc1a.1lIhyEPR03IKZJK/dqJjcG.62hQj0nxqPnXYwqdEmsefkVil0Igaqm48+PbIVkdwfo=")
print ("===============[PRO 4 LOGIN SUKSES]===============\n")
ki5 = LINE("EvM0KbMiP5jUNa9hJ4X7.v0+YsNcy6Qf+zQkQkIxWfW.cTSZMalsaT0AJGj83rLUYeAwWobFnKEkaGBp7FPdiJQ=")
print ("===============[PRO 5 LOGIN SUKSES]===============\n")
ki6 = LINE("Eu8rr4JM9p4Lr4jkUwzf.1UtSulxUuS5RQiuTuoGutW.SE5mdIXi9wjLDeylqu4hJSZAPNYLKBCCVjFrtQPmbgM=")
print ("===============[PRO 6 LOGIN SUKSES]===============\n")
ki7 = LINE("EuHbHTn1ugxHtDaABdN6.kIeNKAgGarsTjKK76RJxTG.EWGSeY7I0ll6IXLPh4eIHxDl89s1Ag0rmBv67gH/P9U=")
print ("===============[PRO 7 LOGIN SUKSES]===============\n")
ki8 = LINE("EuqfqCLaIrO44ZyablYf.NfyvVjeUCr6YFe+KNIAklW.qWtqpnjXEtNZ89CKVjPX9HmGApLV+aNHHNbSqcP3Vs8=")
print ("===============[PRO 8 LOGIN SUKSES]===============\n")
ki9 = LINE("Evy7knmCeo6llDk3C3af.OcGe7R4qw0JOoTpwx4hFNW.y9tuFYHmjCWjt5n+JxN48ZgLEFXMVjMGw9VV2DHcQzE=")
print ("===============[PRO 9 LOGIN SUKSES]===============\n")
ki10 = LINE("EukfFP8DJbfSNB2brTzd.9XWyTjOnp3cCw1lmXbvjNq.BfBj6eu31RxpXIXZ2sjjwTTMaCEq/NmGeOh6SVm0/iE=")
...
dd1 = LINE("Ev0Q1rwEzWGcoO3fUFhf.6nK7QU+e+3Ow8fEI/Ld17W.y9RQKSzZek38I2iyOGYh9uew3zt3aCbNeDJGmG4jeEM=")
print ("===============[LEADER 1 LOGIN SUKSES]===============\n")
dd2 = LINE("Ev0Q1rwEzWGcoO3fUFhf.6nK7QU+e+3Ow8fEI/Ld17W.y9RQKSzZek38I2iyOGYh9uew3zt3aCbNeDJGmG4jeEM=")
print ("===============[LEADER 2 LOGIN SUKSES]===============\n")
dd3 = LINE("Euue9CsFaTZmli3VqoPe.o06u8YlkPK5Q3FCvOuFsxG.ifVWkBuSX99vHo57XrbI8yLl9UH3mjMwXhSDxCE5xV8=")
print ("===============[LEADER 3 LOGIN SUKSES]===============\n\n======================================\n        AUTO PROTECT BOT LINE\n            CREATOR : DEDE\n           DEDE SHOP CENTRE\n======================================\n\n[DOTS AUTO PROTECT BOT START]")


KAC = [client,dots,ki1,ki2,ki3,ki4,ki5,ki6,ki7,ki8,ki9,ki10]
...
creator = ["u33699ed350f7715fce593dd4e8a5d475","ue8d93baaefc4ff7a16f057a2fa50f5ef"]
Owner = ["u33699ed350f7715fce593dd4e8a5d475","ue8d93baaefc4ff7a16f057a2fa50f5ef"]
admin = ["u33699ed350f7715fce593dd4e8a5d475","ue8d93baaefc4ff7a16f057a2fa50f5ef"]
target = []
...
#SELFPRO START
						...
						if cmd == "pro speed":
							if msg._from in Bot:
								...
								elapsed_time = time.time() - start
								ki1.sendMessage(to, "➧ Pro 1 speed : \n   {} Detik".format(str(elapsed_time)))
								elapsed_time = time.time() - start
								...
								elapsed_time = time.time() - start
								ki6.sendMessage(to, "➧ Pro 6 speed : \n   {} Detik".format(str(elapsed_time)))
								elapsed_time = time.time() - start
								ki7.sendMessage(to, "➧ Pro 7 speed : \n   {} Detik".format(str(elapsed_time)))
								elapsed_time = time.time() - start
								ki8.sendMessage(to, "➧ Pro 8 speed : \n   {} Detik".format(str(elapsed_time)))
								elapsed_time = time.time() - start
								ki9.sendMessage(to, "➧ Pro 9 speed : \n   {} Detik".format(str(elapsed_time)))
								elapsed_time = time.time() - start
								ki10.sendMessage(to, "➧ Pro 10 speed : \n   {} Detik".format(str(elapsed_time)))
						if cmd == "check":
							if msg._from in Bot:
...
#PUBLIC BOT START
							...
							if settings["checkContact"] == True:
								dots.sendMessage(to, "➧ Kirim Kotaknya")
							else:
								settings["checkContact"] = True
								dots.sendMessage(to, "➧ Kirim Kotaknya")
				...
				if op.param2 in admin:
					...
					if op.param2 not in Bots:
						if op.param2 in admin:
							...
							random.choice(GUE).cancelGroupInvitation(op.param1,[op.param3])
							random.choice(GUE).kickoutFromGroup(op.param1,[op.param2])
							random.choice(GUE).sendMessage(op.param1,"➧ Jangan asal invite orang..!!!")
		if op.type == 11:
			if op.param2 not in Bots:
				if op.param2 in admin and Bots and Owner:
					...
					random.choice(GUE).sendMessage(op.param1,"➧ Jangan mainin QR...!!!")
